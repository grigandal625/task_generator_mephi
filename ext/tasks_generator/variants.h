...
namespace ailab
{
  ...
  public:
    variants_t(config_t const &config = config_t()) noexcept : fitness(0),
                                                               changed(true),
                                                               config(config),
    ...
    variants_t(variants_t const &v) noexcept : fitness(v.fitness),
                                               changed(v.changed),
                                               config(v.config),
    ...
    variants_t(variants_t &&v) noexcept : config(v.config)
    {
